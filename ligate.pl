...
#    - now reads both O3' and O3*, which are used interchangeably in some PDB files
#    - ligates preferentially along the same chain, unless it cannot find a link within a threshold of 4 angstroms
...
my $verbose = 0; #toggle verbose mode  1=verbose, 0=quiet
